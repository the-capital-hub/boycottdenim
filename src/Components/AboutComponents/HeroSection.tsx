				...
				<div className={`${ptMono.className}`}>
					...
					<div className="hidden lg:grid grid-cols-2 gap-10 items-center">
						...
						<div className="space-y-6">
							...
							<h2 className="text-[64px] font-semibold text-black">Boy Cott</h2>
							...
							<div className="text-[20px] text-gray-700 leading-relaxed space-y-6 w-full lg:w-[100vw] xl:w-[85vw]">
								<p>
									At <span className="font-bold text-black">Boy Cott</span>,
									we’ve made a bold decision – to master one thing and one thing
									only: jeans. While the world jumps from trend to trend, we
									stay rooted in what we believe: denim is not just a fabric –
									it’s a culture, a statement, a lifestyle.
								</p>
								<p>
									We built Boy Cott for people who know who they are. People who
									don&apos;t need loud logos or fancy hype to stand out. People
					...
					<div className="lg:hidden flex flex-col items-center text-center gap-6">
						...
						<div className="text-[14px] text-gray-700 leading-relaxed space-y-4 px-2">
							...
							<p>
								We built Boy Cott for people who know who they are. People who
								don&apos;t need loud logos or fancy hype to stand out. People
								who believe in quality over quantity, style over noise, and real
								over fake.
							</p>
							<p>
								Every pair of Boy Cott jeans is designed from the ground up –
