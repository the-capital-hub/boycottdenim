  ...
  return (
    <div className="min-h-screen bg-[#f9f9fb] flex font-['Open Sans'] text-[#3e3e3e]">
      ...
      <div className="flex-1 px-10 py-6">
        ...
        {/* Recent Transactions */}
        <div className="mt-10">
          <div className="text-xl font-semibold mb-3">Recent Transaction</div>
          <div className="flex gap-6 text-sm font-medium text-[#999] border-b border-[#ccc] pb-2">
              ...
              <tbody>
                {[160, 20, 12, 15, 10, 20, 30].map((amount, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td className="px-4 py-3">{index === 1 ? "Invoice" : index === 4 ? "Cash" : "Credit Card"}</td>
